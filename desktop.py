...
Label(root,image=logo,bg="black").place(x=620,y=0)

Label(root,text="إخفاء النص في الصورة",bg="black",fg="#126161",font="Tahoma 25").place(x=320,y=15)
...
B1 = Button(frame3,text='افتح الصورة',width=10,height=2,bg="#126161",fg="black",font='Tahoma 14 bold',command=showimage).place(x=180,y=15)
B2 = Button(frame3,text='احفظ الصورة',width=10,height=2,bg="#0B4040",fg="black",font='Tahoma 16 bold',command=save).place(x=20,y=12)
...
B3 = Button(frame4,text='إخفاء النص',width=10,height=2,bg="#126161",fg="black",font='Tahoma 14 bold',command=Hide).place(x=20,y=15)

B4 = Button(frame4,text='إظهار النص',width=10,height=2,bg="#126161",fg="black",font='Tahoma 14 bold',command=Show).place(x=180,y=15)
